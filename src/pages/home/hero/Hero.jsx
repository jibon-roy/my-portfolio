...
const Hero = ({ color, whiteColor }) => {
  ...
  return (
    <>
      <div className="mb-40">
        <div
          className="hero min-h-full md:min-h-[60vh] mb-20 z-0"
          ...
          <div className="hero-content md:gap-20 justify-center max-w-5xl flex-col lg:flex-row">
            ...
            <div>
              ...
              <p className="py-10" style={{ color: color }}>
                Hello I&#39;m Jibon Krishna Roy an Enthusiastic MERN stack
                developer dedicated to crafting seamless web experiences.
                Proficient in MongoDB, Express.js, React.js, and Node.js, I
                specialize in building robust, scalable websites. Committed to
                clean code and innovative problem-solving, I thrive in
                collaborative environments. Let&#39;s elevate your digital
